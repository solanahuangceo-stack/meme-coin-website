	...
	return (
		<section ref={ref} className='py-24 px-4 relative'>
			...
			<div className='max-w-5xl mx-auto relative z-10'>
				...
				>
					<span className='text-gradient'>WTF is $MEME?</span>
				</motion.h2>
				...
				<div className='grid md:grid-cols-2 gap-8 mb-12'>
					...
					>
						<p className='text-lg text-foreground/90 leading-relaxed mb-4'>
							$MEME is what happens when the internet gets bored and discovers blockchain technology. We took the
			...
			<div className='flex flex-col lg:flex-row items-center justify-center gap-6 pt-10 sm:gap-8 lg:gap-12 max-w-6xl mx-auto'>
				<div className='w-full aspect-[16/10] sm:aspect-[16/9] rounded-lg overflow-hidden border-4 border-accent shadow-2xl'>
					<iframe
						src='https://dexscreener.com/solana/asxuurmabxgqpe5pyshresrkba1nmpfnmwgkhi4cqqrh?embed=1&amp;theme=dark&amp;trades=0&amp;info=0'
			...
			<div className='flex flex-col lg:flex-row items-center justify-center gap-6 pt-10 sm:gap-8 lg:gap-12 max-w-6xl mx-auto'>
				<div className='w-fit px-4 py-2 flex flex-row gap-2 rounded-md border-2 border-purple-600 shadow-lg bg-background/70'>
					<h1>CA: ${ADDRESS}</h1>
					<button
						onClick={() => {
