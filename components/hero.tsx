...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
      ...
      >
        <span className="text-gradient">Welcome to $MEME</span>
      </motion.h1>
      ...
      >
        ...
        >
          ...
          <Image
            src="/stylized-minimalist-doge-dog-mascot-wearing-suit-m.jpg"
            alt="$MEME Mascot"
            width={288}
            height={288}
            className="relative z-10 drop-shadow-2xl grayscale hover:grayscale-0 transition-all duration-500"
          />
        </motion.div>
      </motion.div>
