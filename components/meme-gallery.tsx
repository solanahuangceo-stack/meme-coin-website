...
const memes = [
  { id: 1, query: "minimalist crypto doge portrait monochrome elegant" },
  { id: 2, query: "abstract geometric trading chart art minimal" },
  { id: 3, query: "stylized rocket moon minimal design dark" },
  { id: 4, query: "diamond hands illustration minimal elegant" },
  { id: 5, query: "ape silhouette minimal crypto art dark" },
  { id: 6, query: "chart going up abstract minimal art" },
]
